...
def test_happy_path_success_login_from_personal_account_button_with_valid_values():
    driver = webdriver.Chrome()
...
def test_happy_path_success_login_from_register_page_with_valid_values():
    driver = webdriver.Chrome()
...
def test_happy_path_success_login_from_forgot_password_page_with_valid_values():
    driver = webdriver.Chrome()
